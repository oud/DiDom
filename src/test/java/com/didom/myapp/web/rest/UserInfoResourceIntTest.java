...
import com.didom.myapp.service.UserInfoService;
...
public class UserInfoResourceIntTest {
    ...
    private static final TypeUser DEFAULT_USER_TYPE = TypeUser.RECRUITER;
    private static final TypeUser UPDATED_USER_TYPE = TypeUser.CANDIDATE;

    private static final Integer DEFAULT_ACTION_RANGE = 1;
    private static final Integer UPDATED_ACTION_RANGE = 2;
    ...
    public static UserInfo createEntity(EntityManager em) {
        UserInfo userInfo = new UserInfo()
            ...
            .actionRange(DEFAULT_ACTION_RANGE)
    ...
    public void createUserInfo() throws Exception {
        ...
        assertThat(testUserInfo.getActionRange()).isEqualTo(DEFAULT_ACTION_RANGE);
        assertThat(testUserInfo.isAvailability()).isEqualTo(DEFAULT_AVAILABILITY);
    ...
    public void getAllUserInfos() throws Exception {
        ...
        restUserInfoMockMvc.perform(get("/api/user-infos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].actionRange").value(hasItem(DEFAULT_ACTION_RANGE)))
    ...
    public void getUserInfo() throws Exception {
        ...
        restUserInfoMockMvc.perform(get("/api/user-infos/{id}", userInfo.getId()))
            ...
            .andExpect(jsonPath("$.actionRange").value(DEFAULT_ACTION_RANGE))
    ...
    public void updateUserInfo() throws Exception {
        ...
        updatedUserInfo
            ...
            .actionRange(UPDATED_ACTION_RANGE)
        ...
        assertThat(testUserInfo.getActionRange()).isEqualTo(UPDATED_ACTION_RANGE);
        assertThat(testUserInfo.isAvailability()).isEqualTo(UPDATED_AVAILABILITY);
