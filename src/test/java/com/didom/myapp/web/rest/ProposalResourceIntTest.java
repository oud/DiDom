...
public class ProposalResourceIntTest {
    ...
    private static final PaymentType UPDATED_PAYMENT_TYPE = PaymentType.FIXED_PRICE;

    private static final BigDecimal DEFAULT_PAYMENT_AMOUNT = new BigDecimal(1);
    private static final BigDecimal UPDATED_PAYMENT_AMOUNT = new BigDecimal(2);

    private static final ProposalStatus DEFAULT_CURRENT_PROPOSAL_STATUS = ProposalStatus.SENT;
    private static final ProposalStatus UPDATED_CURRENT_PROPOSAL_STATUS = ProposalStatus.ACCEPTED;
    ...
    public static Proposal createEntity(EntityManager em) {
        Proposal proposal = new Proposal()
            ...
            .currentProposalStatus(DEFAULT_CURRENT_PROPOSAL_STATUS)
    ...
    public void createProposal() throws Exception {
        ...
        assertThat(testProposal.getPaymentType()).isEqualTo(DEFAULT_PAYMENT_TYPE);
        assertThat(testProposal.getPaymentAmount()).isEqualTo(DEFAULT_PAYMENT_AMOUNT);
        assertThat(testProposal.getCurrentProposalStatus()).isEqualTo(DEFAULT_CURRENT_PROPOSAL_STATUS);
    ...
    public void getAllProposals() throws Exception {
        ...
        restProposalMockMvc.perform(get("/api/proposals?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].currentProposalStatus").value(hasItem(DEFAULT_CURRENT_PROPOSAL_STATUS.toString())))
    ...
    public void getProposal() throws Exception {
        ...
        restProposalMockMvc.perform(get("/api/proposals/{id}", proposal.getId()))
            ...
            .andExpect(jsonPath("$.currentProposalStatus").value(DEFAULT_CURRENT_PROPOSAL_STATUS.toString()))
    ...
    public void updateProposal() throws Exception {
        ...
        updatedProposal
            ...
            .currentProposalStatus(UPDATED_CURRENT_PROPOSAL_STATUS)
        ...
        assertThat(testProposal.getPaymentType()).isEqualTo(UPDATED_PAYMENT_TYPE);
        assertThat(testProposal.getPaymentAmount()).isEqualTo(UPDATED_PAYMENT_AMOUNT);
        assertThat(testProposal.getCurrentProposalStatus()).isEqualTo(UPDATED_CURRENT_PROPOSAL_STATUS);
