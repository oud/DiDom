...
public class HasSkillResourceIntTest {
    ...
    public void createHasSkill() throws Exception {
        ...
        assertThat(testHasSkill.getPaymentType()).isEqualTo(DEFAULT_PAYMENT_TYPE);
        assertThat(testHasSkill.getPaymentAmont()).isEqualTo(DEFAULT_PAYMENT_AMONT);
    ...
    public void updateHasSkill() throws Exception {
        ...
        HasSkill testHasSkill = hasSkillList.get(hasSkillList.size() - 1);
        assertThat(testHasSkill.getPaymentType()).isEqualTo(UPDATED_PAYMENT_TYPE);
        assertThat(testHasSkill.getPaymentAmont()).isEqualTo(UPDATED_PAYMENT_AMONT);
