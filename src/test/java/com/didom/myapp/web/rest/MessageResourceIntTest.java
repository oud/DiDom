...
import com.didom.myapp.service.MessageService;
...
public class MessageResourceIntTest {
    ...
    private static final ProposalStatus DEFAULT_PROPOSAL_STATUS = ProposalStatus.SENT;
    private static final ProposalStatus UPDATED_PROPOSAL_STATUS = ProposalStatus.ACCEPTED;
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getProposalStatus()).isEqualTo(DEFAULT_PROPOSAL_STATUS);
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].proposalStatus").value(hasItem(DEFAULT_PROPOSAL_STATUS.toString())));
    }
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.proposalStatus").value(DEFAULT_PROPOSAL_STATUS.toString()));
    }
    ...
    public void updateMessage() throws Exception {
        ...
        updatedMessage
            ...
            .proposalStatus(UPDATED_PROPOSAL_STATUS);
        ...
        assertThat(testMessage.getProposalStatus()).isEqualTo(UPDATED_PROPOSAL_STATUS);
